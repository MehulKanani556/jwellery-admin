        ...
        loading ? <div className="flex justify-center items-center h-[calc(100vh-64px)]" ><Loader /></div> :
            <div className="container p-5 md:p-10 ">
                <div className="flex flex-col lg:flex-row gap-3 justify-between items-center">
                    ...
                    <div>
                        <div className="flex flex-wrap justify-center ld:justify-end gap-4  mb-4">
                            {filtersApplied ? (
                                <button
                                    type="button"
                                ...
                                <div className="">
                                    ...
                                    <div className=" p-3 pt-0">
                                        <div className="mt-4">
                                            ...
                                            <select
                                                name="type"
                                                className={`border border-brown rounded w-full p-3 mt-1 ${selectType == '' ? 'text-gray-400' : 'text-black'}`}
                                    ...
                                    <form onSubmit={handleSubmit} className="p-4 md:p-8 rounded-lg">
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <Field
                                                ...
                                                name="type"
                                                id="type"
                                                className={`mt-1 block w-full border border-brown p-2 rounded ${values.type == 'click' ? 'text-gray-400' : 'text-black'}`}                                            >
                                                <option value="">Select Offer Type</option>
                                                <option value="percentage">Percentage</option>
                                                <option value="fixed">Fixed Amount</option>
                                            </Field>
